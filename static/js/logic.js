...
// Store USGS Earthquake API endpoint inside quakeUrl
var quakeUrl = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
// Store Tectonic Plate API endpoint inside platesUrl
...
d3.json(quakeUrl, function(data) {
  ...
  // Perfom a GET request to the plates URL inside other d3.json 
...
function createMap(earthquakeData,platesData) {
  ...
  var streetmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}-v9/tiles/256/{z}/{x}/{y}?access_token={accessToken}", {
  ...
  var darkmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}-v9/tiles/256/{z}/{x}/{y}?access_token={accessToken}", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 18,
    id: "dark",
    accessToken: API_KEY
  ...
  var satellite = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}-v9/tiles/256/{z}/{x}/{y}?access_token={accessToken}", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 18,
    id: "satellite",
    accessToken: API_KEY
  ...
  var lightmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}-v9/tiles/256/{z}/{x}/{y}?access_token={accessToken}", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 18,
    id: "light",
    accessToken: API_KEY
